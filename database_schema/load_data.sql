...
LOAD DATA INFILE '/Users/ykuang/Desktop/2020-2021Winter/oop/final_project/react-flask-app/database_schema/student_section.csv'
INTO TABLE student_section
FIELDS TERMINATED BY ','
ENCLOSED BY '"'
LINES TERMINATED BY '/n'
IGNORE 1 ROWS;

LOAD DATA INFILE '/Users/ykuang/Desktop/2020-2021Winter/oop/final_project/react-flask-app/database_schema/instructors.csv'
...
LOAD DATA INFILE '/Users/ykuang/Desktop/2020-2021Winter/oop/final_project/react-flask-app/database_schema/students.csv'
INTO TABLE students
FIELDS TERMINATED BY ','
ENCLOSED BY '"'
LINES TERMINATED BY '/n'
